...
parser.add_argument('--config', type=str, default='/content/drive/MyDrive/Colab_Notebooks/data/Upstage_recycling_Object_Detection/mmdetection/configs_custom/codino/co_dino_5scale_swin_l_16xb1_16e_o365tococo.py', help='Path to the config file')
parser.add_argument('--checkpoint', type=str, default='/content/drive/MyDrive/Colab_Notebooks/data/Upstage_recycling_Object_Detection/mmdetection/work_dirs/epoch_9.pth', help='Path to the checkpoint file')
...
# COCO 객체 생성
coco = COCO('/content/drive/MyDrive/Colab_Notebooks/data/Upstage_recycling_Object_Detection/recycling/test.json')
...
for img_id in tqdm(img_ids):
    ...
    # 추론 수행
    img_path = os.path.join('/content/drive/MyDrive/Colab_Notebooks/data/Upstage_recycling_Object_Detection/recycling', img_info['file_name'])
